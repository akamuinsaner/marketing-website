    ...
    return (
        <section className="flex flex-col gap-12 tablet:gap-16 desktop:gap-16 px-3 tablet:px-4 desktop:px-24 py-12 tablet:py-16 desktop:py-24">
            <div className="flex flex-col gap-5 text-center">
                <h6
                    className="text-3xl text-primary font-semibold tablet:text-5xl"
                >
            ...
            <div>
                <ul className="flex flex-col">
                    {qaList.map(qa => {
                        ...
                        return (
                            <li className="flex gap-4 py-7 border-b border-solid border-primary first:pt-0 last:border-none">
                                <div className="flex flex-col flex-1">
                                    <h6
                                        className="text-lg font-medium text-primary"
                                    >{qa.question}</h6>
                                    {isOpening ? <p className="text-base text-secondary mt-2">
                                        {qa.answer}
                                    </p> : null}
                                </div>
                                <a
                                ...
                                >
                                    <img
                                        ...
                                        src={isOpening ? '/indeterminate-circle-line.png' : '/add-circle-line.png'}
                ...
                <div className="flex items-center flex-col tablet:flex-row p-4 tablet:p-8 gap-4 border border-solid border-primary rounded-lg shadow-md">
                    ...
                    <a className="w-full tablet:w-auto py-3 px-5 rounded bg-brand-primary text-primary-invert text-center shadow text-base font-medium cursor-pointer hover:bg-brand-primary-emphasize">
                        Get in touch
                    </a>
                </div>
            </div>
