    ...
    return (
        <header className='w-full h-nav-bar fixed pt-4 bg-white flex items-center px-4 tablet:px-8 desktop:px-28 top-0 inset-x-0'>
            <a
                ...
                href='/'
            >
                <img src='/logo.png' className='h-8 w-8 relative' alt='' />
            ...
            >
                <img alt='' src='/menu-fill.png' className='h-5 w-5' />
            </button>
            <Drawer
                open={open}
                ...
                <div className='flex items-center'>
                    ...
                    >
                        <div className='h-8 w-8 relative'>
                            <Image alt='logo' src='/logo.png' fill={true} />
                        </div>
                        <span className='font-bold text-base text-primary'>
                            Abstractly
                        </span>
                    ...
                    >
                        <img alt='close' src='/close.png' className='h-5 w-5' />
                    </button>
                </div>
                <ul
