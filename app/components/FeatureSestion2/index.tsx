                    ...
                    <li className='flex gap-5 items-start'>
                        ...
                        <div className='py-2.5 flex flex-col gap-2'>
                            ...
                            <p className='text-base text-secondary'>
                                All images boast a minimum resolution of 5K,
                                ensuring crisp, crystal-clear quality.
                            </p>
                        </div>
                    </li>
                    <li className='flex gap-5 items-start'>
                        ...
                        <div className='py-2.5 flex flex-col gap-2'>
                            ...
                            <p className='text-base text-secondary'>
                                We offer a wide array of abstractions, ranging
                                from water to glass, and encompassing various
                                styles including 3D and vector.
                            </p>
                        </div>
                    </li>
                    <li className='flex gap-5 items-start'>
                        ...
                        <div className='py-2.5 flex flex-col gap-2'>
                            ...
                            <p className='text-base text-secondary'>
                                ...
                                - whether it's a stunning wallpaper or
